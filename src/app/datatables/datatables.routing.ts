    ...
    children: [
      {
        ...
        data: {
          ...
          urls: [{ title: 'Dashboard', url: '/dashboard' }, { title: 'Basic Datatable' }],
        },
      },
      {
        path: 'editing',
        ...
        data: {
          title: 'Editing Table',
          urls: [{ title: 'Dashboard', url: '/dashboard' }, { title: 'Editing Table' }],
        },
      },
      {
        path: 'filter',
      ...
      },
      {
        ...
        data: {
          ...
          urls: [{ title: 'Dashboard', url: '/dashboard' }, { title: 'Material Table' }],
        },
      },
    ],
  },
