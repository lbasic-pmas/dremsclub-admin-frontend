    ...
    children: [
      {
        ...
        data: {
          ...
          urls: [{ title: 'Dashboard', url: '/dashboard' }, { title: 'Dynamic Data with tree' }],
        },
      },
      {
        path: 'flat-tree',
        ...
        data: {
          ...
          urls: [{ title: 'Dashboard', url: '/dashboard' }, { title: 'Flat Data with Tree' }],
        },
      },
      {
        path: 'load-tree',
        ...
        data: {
          ...
          urls: [{ title: 'Dashboard', url: '/dashboard' }, { title: 'Loaded Data with Tree' }],
        },
      },
      {
        path: 'nested-tree',
        ...
        data: {
          title: 'Nested Tree',
          urls: [{ title: 'Dashboard', url: '/dashboard' }, { title: 'Nested Tree' }],
        },
      },
    ],
  },
